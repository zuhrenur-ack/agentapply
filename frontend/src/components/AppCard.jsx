...
import { MapPin, ExternalLink, MoreHorizontal, Sparkles } from 'lucide-react'
        ...
        <div className="flex items-center justify-between pt-2 border-t border-rose-soft/40 gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 rounded-lg text-[11px] font-medium text-rose-medium hover:bg-rose-soft/40 transition-colors"
              title="Ön Yazı Üret"
            >
              <Sparkles size={12} />
              Ön Yazı
